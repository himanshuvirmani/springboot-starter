...
/**
 * This class obtains the current time by using a {@link com.fquick.core.util.datetime.provider.DateTimeService}
...
public class AuditingDateTimeProvider implements DateTimeProvider {
    ...
    private final com.core.util.datetime.provider.DateTimeService dateTimeService;

    public AuditingDateTimeProvider(com.core.util.datetime.provider.DateTimeService dateTimeService) {
