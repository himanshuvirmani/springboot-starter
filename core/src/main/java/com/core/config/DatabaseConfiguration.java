...
import com.core.util.datetime.provider.AuditingDateTimeProvider;
import com.core.util.datetime.provider.DateTimeService;
...
@EnableJpaRepositories(basePackages = {"com.springboot.template.repository"})
@EntityScan(basePackages = {"com.springboot.template.domain"})
